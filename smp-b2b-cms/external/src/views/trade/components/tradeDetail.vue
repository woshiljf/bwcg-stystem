      ...
      <el-card class="box-card packing">
        <el-form :model="temp">
          <el-row class="text item">
            ...
            <el-col :span="4">
              <el-input v-model="shipment.shipmentOrderNo" :value="shipment.shipmentOrderNo" :readonly="shipmentOrderNoBoole" style="width: 80%;" maxlength="40" placeholder="请输入出货单号" autocomplete="off"/>
            </el-col>
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          modifyB2BShipmentType(tempData).then((res) => {
